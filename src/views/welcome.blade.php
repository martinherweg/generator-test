...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="{{url('/')}}/favicons/android-chrome-192x192.png" sizes="192x192">
        ...
        <meta name="msapplication-TileImage" content="{{url('/')}}/favicons/mstile-144x144.png">
        <meta name="theme-color" content="#ffffff">
        <title>Ravensburger tiptoi®</title>
        <link rel="stylesheet" href="assets/css/style.css">
        <script src="{{url('/')}}/assets/js/vendor/modernizr-custom.min.js"></script>
    </head>
    <body>
        <script>
