...
const paths = {
  ...
  dest: path.join(config.dist.base, config.dist.css)
}
...
const compileCss = () => {
  ...
  return gulp
    ...
    .on('error', function(err) {
      const error = `
      <div class="bs-fullscreen" style="position: fixed; top: 0; left: 0; width: 100%; background: rgba(0,0,0,.85); height: 100vh; color: #e8e8e8; text-align: left; white-space: pre;
